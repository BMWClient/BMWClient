...
class Theme(val name: String) : Closeable {
    ...
    fun compileShader(): Boolean {
        ...
        readShaderBackground()?.let { shaderBackground ->
            compiledShaderBackground = CanvasShader(resourceToString("/resources/bmwclient/shaders/vertex.vert"),
                shaderBackground)
    ...
    companion object {
        ...
        fun defaults() = runCatching {
            ...
            val stream = resource("/resources/bmwclient/default_theme.zip")
