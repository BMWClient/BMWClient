...
loom {
    accessWidenerPath = file("src/main/resources/bmwclient.accesswidener")
}
...
tasks.register<NodeTask>("bundleTheme") {
    ...
    outputs.files("src-theme/resources/assets/bmwclient/default_theme.zip")
}
...
tasks.register<CompareJsonKeysTask>("verifyI18nJsonKeys") {
    ...
    val languageFolder = file("src/main/resources/resources/bmwclient/lang")
